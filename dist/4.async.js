(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  [4],
  {
    "B+Dq": function(e, t, a) {
      ...
      x.defaultProps = { buttonText: "\u83b7\u53d6\u9a8c\u8bc1\u7801" };
      var I = {};
      Object.keys(E.default).forEach(function(e) {
        var t = E.default[e];
        I[e] = function(a) {
          return g.default.createElement(C.default.Consumer, null, function(n) {
            return g.default.createElement(
              x,
        ...
        g = function(e) {
          return f.default.createElement(p.default.Consumer, null, function(t) {
            return f.default.createElement(
              v,
              (0, l.default)({ tabUtil: t.tabUtil }, e)
            );
          });
        };
      g.typeName = "LoginTab";
    ...
    Y5yc: function(e, t, a) {
      ...
      var u,
        ...
        b = n(a("QBZU")),
        y = n(a("w2qy")),
        E = b.default.UserName,
        C = b.default.Password,
        w = b.default.Submit,
        x = ((u = (0, v.connect)(function(e) {
          var t = e.login,
            a = e.loading;
          ...
          (o = (function(e) {
            function t() {
              ...
              return (
                (a = (0, f.default)(
                  this,
                  (e = (0, p.default)(t)).call.apply(e, [this].concat(r))
                )),
                ...
                (a.onGetCaptcha = function() {
                  return new Promise(function(e, t) {
                    a.loginForm.validateFields(["mobile"], {}, function(n, r) {
                      if (n) t(n);
                      else {
                        var l = a.props.dispatch;
                        l({ type: "login/getCaptcha", payload: r.mobile })
                          .then(e)
                          .catch(t);
                      }
                    });
                ...
                (a.handleSubmit = function(e, t) {
                  var n = { usernameOrEmail: t.userName, password: t.password };
                  a.state.type;
                  if (!e) {
                    var r = a.props.dispatch;
                    r({ type: "login/login", payload: (0, s.default)({}, n) });
                  }
                }),
                    ...
                    return h.default.createElement(
                      ...
                      h.default.createElement(
                        ...
                        h.default.createElement(
                          ...
                          h.default.createElement(
                            l.default,
                            { checked: u, onChange: this.changeAutoLogin },
                            h.default.createElement(g.FormattedMessage, {
        ...
        o = {
          UserName: {
            props: {
              size: "large",
              id: "userName",
              prefix: l.default.createElement(r.default, {
                type: "user",
