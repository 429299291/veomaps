    ...
    ALo4: function(e, t, a) {
      ...
      function u(e) {
        ...
        return c.default.createElement(
          ...
          o &&
            c.default.createElement("div", { className: d.default.extra }, o),
          m &&
            c.default.createElement("div", { className: d.default.actions }, m)
        );
      }
    },
    UKiy: function(e, t, a) {
        ...
        u = r.default.createElement(
          ...
          r.default.createElement(
            ...
            r.default.createElement(
              ...
              { size: "large" },
              r.default.createElement(n.FormattedMessage, {
                id: "app.register-result.back-home"
              })
            )
          )
        ),
          ...
          return r.default.createElement(i.default, {
            ...
            title: r.default.createElement(
              ...
              r.default.createElement(n.FormattedMessage, {
                ...
                values: {
                  email: t.state ? t.state.account : "AntDesign@example.com"
                }
              })
            ),
            description: (0, n.formatMessage)({
