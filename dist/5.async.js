                    ...
                    (a.checkPassword = function(e, t, r) {
                      ...
                      if (t)
                        if (
                          ...
                          t &&
                            i &&
                            n.validateFields(["confirm"], { force: !0 }),
                            r();
                        }
                      else
                        a.setState({
                          help: (0, F.formatMessage)({
                    ...
                    (a.renderPasswordProgress = function() {
                      ...
                      return t && t.length
                        ? y.default.createElement(
                            "div",
                            { className: S.default["progress-".concat(r)] },
                            y.default.createElement(d.default, {
                              status: z[r],
                              className: S.default.progress,
                              strokeWidth: 6,
                              percent:
                                10 * t.length > 100 ? 100 : 10 * t.length,
                              showInfo: !1
                            })
                          )
                        : null;
                                ...
                                y.default.createElement(
                                  ...
                                  y.default.createElement(
                                    i.default,
                                    {
                                      size: "large",
                                      disabled: d,
                                      className: S.default.getCaptcha,
