...
app.model({ namespace: 'bike', ...(require('/Users/zhuangenze/Desktop/manhattan-admin-web/src/models/bike.js').default) });
...
app.model({ namespace: 'profile', ...(require('/Users/zhuangenze/Desktop/manhattan-admin-web/src/pages/Profile/models/profile.js').default) });
app.model({ namespace: 'error', ...(require('/Users/zhuangenze/Desktop/manhattan-admin-web/src/pages/Exception/models/error.js').default) });
